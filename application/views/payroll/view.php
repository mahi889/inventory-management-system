				...
				<?php 
					foreach($payrolls  as $pay):
					  ...
					  <tr>
					  	...
					  	<td> <?php echo number_format($pay->Pay,2)?></td>
					  	<td><?php echo $pay->dayswork?>Days</td>
					  	<td> <?php echo number_format($pay->otrate,2)?> /hrs</td>
					  	<td><?php echo $pay->othrs?> hrs</td>
					  	<td> <?php echo number_format($pay->allow,2)?></td>
					  	<td> <?php echo number_format($gross,2)?></td>
					  	<td> <?php echo number_format($tax,2)?></td>
					  	<td> <?php echo number_format($pay->advance,2)?></td>
					  	<td> <?php echo number_format($pay->insurance,2)?></td>
					  	<td> <?php echo number_format($totdeduct,2)?></td>
