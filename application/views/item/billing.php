...
?>
<?php echo form_open('items/save_order',array('class' => 'form-horizontal'))?>
				...
				<tr><td><h4>GST (%):</td></h4>
					<td> 
						<div class="form-group">
							<div class="col-lg-8">
								<input type="number" id="tax" name="tax" class="form-control" onchange="tax_calculate(this)" value="18" placeholder="GST" required="">
							</div>
						</div> 
						<h4 id="toal_tax_amount"><?php $vat= .18 * $grand_total;echo number_format($vat,2);?></h4></td></tr>
				<tr><td><h4>Tatal Amount:</td></h4><td>
					<h4 id="total_amount"><?php $total= $grand_total+$vat;echo number_format($total,2);?></h4></td></tr>
			</table>
		</div>
	</div>
</div>
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input type="text" id="search" required=""  name="search" class="form-control" placeholder="Search by First Name, Last Name, Father Name, Place, Contact No">
		...
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input type="text" id="fname" required="" name="fname" class="form-control" placeholder="First Name">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input type="text" id="father_name" required="" name="father_name" class="form-control" placeholder="Father Name">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input type="text" id="place" name="place" required="" class="form-control" placeholder="Place">
			</div>
		</div>
		...
		<!-- <div class="form-group form-inline">
			...
			<div style="float:left;padding: 6px 18px 2px 16px;">
				...
				<select name="month"  id="month" style="width:auto;" class="form-control">
					<option value="0">Month</option><?php echo generate_options(1,18)?>
				</select>
		...
		<div class="form-group">
			...
			<div class="col-lg-2">
				<input type="text" id="Eway" value="<?php echo strtotime("now") ?>" maxlength="16"  name="Eway" class="form-control" required="" >
			</div>
		</div>
		...
		<div class="form-group form-inline">
			...
			<div class="col-sm-2">
				<div class="input-group">
					...
					<select name="delivered_staus" class="form-control">
		...
		<div class="form-group">
			<label class="control-label col-sm-2">Pay Amount</label>
			<div class="col-lg-2">
				<input type="number" required="" id="received_amount" max="<?php echo number_format($total,2); ?>" name="received_amount" step=".01" onkeyup="dueamountcalc();"  class="form-control">
			</div>
		</div>
		...
		<div id="payment_status_block" class="form-group form-inline " >
			...
			<div class="col-sm-2">
				<div class="input-group">
				<div class="input-group-addon"></div>
					<select required="" id="payment_status" name="payment_status" class="form-control">
		...
		<div id="dueamount_block" class="form-group ">
			...
			<div class="col-lg-2">
				<input type="number" id="dueamount" step=".01" max="<?php echo number_format($total,2); ?>" name="dueamount"  class="form-control">
			</div>
		</div>
...
<?php echo form_close();?>
 ...
 <style>
  ...
  $( function() {
  	...
  	$( "#search" ).autocomplete({
      //source: "<?php echo site_url('items/search_accaunt'); ?>",
      source: function (request, response) {
         // request.term is the term searched for.
         // response is the callback function you must call to update the autocomplete's 
         // suggestion list.
         $.ajax({
             url: "<?php echo site_url('items/search_accaunt'); ?>",
